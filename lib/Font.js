...
function Font(options) {
  ...
  this._fontCssPrefix = this._options.fontCssPrefix || '';
  this._collection = [];
}
...
Font.prototype = {
  ...
  load: function(fontFileName, fontCssFileName) {
    var
      self = this,
      promise;
    ...
    promise = Promise.fromNode(function(callback) {
      ...
      .then(function(content) {
        return self._parseFont(content);
      });
    ...
    if (fontCssFileName) {
      promise = promise.then(function() {
        return Promise.fromNode(function(callback) {
          ...
          .then(function(content) {
            return self._parseFontCss(content);
          });
      })
    }
  ...
  _parseFontCss: function(content) {
    var
      collection,
      map = {},
      cssTree,
      code,
      cssSelectorParser,
      cssSelectorPrefix = this._fontCssPrefix;
