  ...
  _buildSvgSet: function(options) {
    ...
    function prettify() {
      ...
      svgElementCollection.forEach(function(entity, index) {
        ...
        x *= size + PRETTY_PADDING*2;
        y *= size + PRETTY_PADDING*2;
      ...
      root.attr('width', Math.ceil(ratio) * (size + PRETTY_PADDING*2));
      root.attr('height', Math.ceil(ratio) * (size + PRETTY_PADDING*2));
    }
